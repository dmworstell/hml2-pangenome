...
ROOT=OUT.parents[2]
PHY=ROOT/'project/results/acroc_resolved_20260914/phylogeny'
NBOOT=1000
SEED=20260921
...
def apd():
 edges=read(ROOT/'outputs/hml2-pangenome-2026-09-13/Supplementary_Data/Figure_3B_exact_nucleotide_edges.tsv')
 ...
 inputrows=read(PHY/'alignment_inputs.tsv');paths={Path(r['path']).name:Path(r['path']) for r in inputrows}
 cache={};inputs=[]
