...
for ext in ['png','pdf','svg']:
    fig.savefig(P/f'Figure_S21_8q11_LTR_diversity.{ext}',dpi=300,bbox_inches='tight',facecolor='white')
plt.close(fig)

table={'title':'Table S16. Solo-LTR diversity and simple divergence expectations at 8q11.23',
       'A_solo_LTR_comparison':rows,'B_968bp_pair_expectations':summary['sequence_divergence_expectations'],
...
print('Figure S21 and Table S16 are restricted to the 8q11.23 diversity comparison.')
