...
sys.path.insert(0,str(ROOT/'figure_support'))
spec=importlib.util.spec_from_file_location('narrative',ROOT/'figure_support/render_support.py')
...
pdfmetrics.registerFont(TTFont('Mono',matplotlib.font_manager.findfont(FontProperties(family='DejaVu Sans Mono'))))
pdfmetrics.registerFont(TTFont('Sans',matplotlib.font_manager.findfont(FontProperties(family='DejaVu Sans'))))
pdfmetrics.registerFont(TTFont('Bold',matplotlib.font_manager.findfont(FontProperties(family='DejaVu Sans', weight='bold'))))
