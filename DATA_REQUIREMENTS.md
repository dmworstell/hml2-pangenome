...
are available at https://doi.org/10.5281/zenodo.22759510. Version 0.4.2 is
https://doi.org/10.5281/zenodo.22903723.
It includes the corrected Rec catalog and complete testing families.
Extract `HML2_derived_data_v0.4.2.zip` at the matching code repository root.
