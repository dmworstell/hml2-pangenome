...
Delta292 has 10 units under the orthology-aware floor or 17 under the inclusive
...
INPUT = (
    ROOT
    / "manuscript/delta292_why_matched_natural_lesions_v1"
    / "pre_orang_age_matched_lesions.tsv"
)
OUT = ROOT / "manuscript/delta292_source_vs_effect_v1"
...
The observed age-matched count vectors are `[10,1,1,1,1,1,1]` and
...
"""
    ...
    summary = {
        ...
        "age_matched_count_vectors": {
            "orthology_aware_floor": [10, 1, 1, 1, 1, 1, 1],
